{{-- <div class="card-footer">
  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-xl-1">
    Client Informations
  </button>
</div> --}}
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        @foreach ($task->users as $user)
          <a href="{{ route('user.profile', [$user->id]) }}" class="badge badge-info"><i class="far	fa fa-user"></i>
            {{ $user->name }} </a><br>
        @endforeach
                  ...
                  @if (isset($task->sub_tasks) && $task->sub_tasks->count() > 0)
                    @foreach ($task->sub_tasks as $sub_task)
                      <li>
                        ...
                        <small class="badge badge-info"><i class="far	fa fa-user"></i> {{ $sub_task->user->name }}</small>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" data-placeholder="{{ $task->task_status->name }}" @error('status')
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" placeholder="{{ $task->start_date }}" id="start_date"
                    name="start_date" autocomplete="start_date" value="{{ $task->start_date }}" @error('start_date')
